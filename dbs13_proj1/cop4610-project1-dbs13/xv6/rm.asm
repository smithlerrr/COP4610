...
main(int argc, char *argv[])
{
  ...
  47:	e8 fa 02 00 00       	call   346 <unlink>
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 40c:	0f b6 80 b8 0a 00 00 	movzbl 0xab8(%eax),%eax
...
printf(int fd, char *fmt, ...)
{
 ...
 571:	75 27                	jne    59a <printf+0x11f>
          s = "(null)";
 573:	c7 45 f4 75 08 00 00 	movl   $0x875,-0xc(%ebp)
        while(*s != 0){
...
free(void *ap)
{
 ...
 63e:	a1 d4 0a 00 00       	mov    0xad4,%eax
...
free(void *ap)
{
 ...
 709:	a3 d4 0a 00 00       	mov    %eax,0xad4
}
 70e:	c9                   	leave  
 70f:	c3                   	ret    
...
malloc(uint nbytes)
{
 ...
 77a:	89 45 ec             	mov    %eax,-0x14(%ebp)
  if((prevp = freep) == 0){
 77d:	a1 d4 0a 00 00       	mov    0xad4,%eax
 782:	89 45 f0             	mov    %eax,-0x10(%ebp)
 785:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
 789:	75 23                	jne    7ae <malloc+0x46>
    base.s.ptr = freep = prevp = &base;
 78b:	c7 45 f0 cc 0a 00 00 	movl   $0xacc,-0x10(%ebp)
 792:	8b 45 f0             	mov    -0x10(%ebp),%eax
 795:	a3 d4 0a 00 00       	mov    %eax,0xad4
 79a:	a1 d4 0a 00 00       	mov    0xad4,%eax
 79f:	a3 cc 0a 00 00       	mov    %eax,0xacc
    base.s.size = 0;
 7a4:	c7 05 d0 0a 00 00 00 	movl   $0x0,0xad0
 7ab:	00 00 00 
  }
 ...
 801:	a3 d4 0a 00 00       	mov    %eax,0xad4
      return (void*)(p + 1);
 ...
 80c:	eb 38                	jmp    846 <malloc+0xde>
    ...
    if(p == freep)
 80e:	a1 d4 0a 00 00       	mov    0xad4,%eax
