...
printf(int fd, char *s, ...)
{
  ...
  22:	e8 74 03 00 00       	call   39b <write>
}
  27:	c9                   	leave  
  28:	c3                   	ret    
...
forktest(void)
{
  ...
  4a:	eb 1d                	jmp    69 <forktest+0x40>
    pid = fork();
  4c:	e8 22 03 00 00       	call   373 <fork>
  ...
  5e:	75 05                	jne    65 <forktest+0x3c>
      exit();
  60:	e8 16 03 00 00       	call   37b <exit>
{
  int n, pid;
  ...
  95:	e8 66 ff ff ff       	call   0 <printf>
    exit();
  9a:	e8 dc 02 00 00       	call   37b <exit>
  }
  
  for(; n > 0; n--){
    if(wait() < 0){
  9f:	e8 df 02 00 00       	call   383 <wait>
  ...
  b7:	e8 44 ff ff ff       	call   0 <printf>
      exit();
  bc:	e8 ba 02 00 00       	call   37b <exit>
  if(n == N){
    printf(1, "fork claimed to work N times!\n", N);
    exit();
  }
  ...
  if(wait() != -1){
  cb:	e8 b3 02 00 00       	call   383 <wait>
  d0:	83 f8 ff             	cmp    $0xffffffff,%eax
  d3:	74 19                	je     ee <forktest+0xc5>
    printf(1, "wait got too many\n");
  d5:	c7 44 24 04 63 04 00 	movl   $0x463,0x4(%esp)
  dc:	00 
  dd:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
  e4:	e8 17 ff ff ff       	call   0 <printf>
    exit();
  e9:	e8 8d 02 00 00       	call   37b <exit>
  }
  
  printf(1, "fork test OK\n");
  ee:	c7 44 24 04 76 04 00 	movl   $0x476,0x4(%esp)
  f5:	00 
...
main(void)
{
 ...
 10a:	e8 1a ff ff ff       	call   29 <forktest>
  exit();
 10f:	e8 67 02 00 00       	call   37b <exit>
